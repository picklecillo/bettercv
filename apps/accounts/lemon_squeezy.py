...
def build_checkout_url(variant_id: str, user_id: int, user_email: str) -> str:
    ...
    return f"https://bettercv.lemonsqueezy.com/buy/44552d41-0cf0-444a-bb47-1ffbfca4d403/?{params}"
